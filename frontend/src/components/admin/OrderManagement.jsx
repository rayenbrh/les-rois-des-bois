          ...
          <tbody>
            {orders.map(order => (
              <tr key={order._id}>
                ...
                <td>
                  <button
                    className={`btn btn-sm ${order.isPaid ? 'btn-success' : 'btn-danger'}`}
                ...
                <td>
                  <a href={`/api/pdf/invoice/${order._id}`} target="_blank" rel="noopener noreferrer" className="btn btn-sm btn-outline-gold">
                    Invoice
                  </a>
                </td>
              </tr>
